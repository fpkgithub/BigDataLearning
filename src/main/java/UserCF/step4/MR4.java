...
public class MR4
{
    ...
    //输入文件的路径
    private static String inPath = "src/main/data/input/UserCF/step2/output/";

    //输出文件的路径
    private static String outPath = "src/main/data/input/UserCF/step4/";

    //输入文件名
    private static String fileName = "part-r-00000";

    //全局缓存文件路径
    private static String cachePath = "/boy/UserCF/step3/output/part-r-00000";
    ...
    public int run()
    {
        ...
        try
        {
            ...
            String hdfsFilePath = "/boy/UserCF/step4/";
