...
public class Mapper3 extends org.apache.hadoop.mapreduce.Mapper<LongWritable, Text, Text, Text>
{
    ...
    protected void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException
    {
        ...
        for (String line : cacheList)
        {
            ...
            outputKey.set(row_matrix2);
            outputValue.set(row_matrix1 + "_" + df.format(cos));
            //输出：行 列_值
